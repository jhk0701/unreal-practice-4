...
void UUIInventoryMenu::NativeOnInitialized()
{
	Super::NativeOnInitialized();

	QuickSlotButton->OnClicked.AddUniqueDynamic(this, &UUIInventoryMenu::RegisterQuickSlot);
}

void UUIInventoryMenu::Update(UItemBase* InItem)
{
	Super::Update(InItem);
...
void UUIInventoryMenu::InvokeFunc()
{
...
void UUIInventoryMenu::RegisterQuickSlot()
{
	// 퀵슬롯 받아오기
	UPlayerManager* PlayerManager = GetGameInstance()->GetSubsystem<UPlayerManager>();
